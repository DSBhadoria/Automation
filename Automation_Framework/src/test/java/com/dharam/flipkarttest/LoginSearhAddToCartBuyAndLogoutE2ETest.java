...
public class LoginSearhAddToCartBuyAndLogoutE2ETest extends TestBase {
	...
	/*	
		...
		public Object[][] getDataFromDataprovider() {
			return GenericUtil.getTestData(sheetName);
		}
	 */
	...
	public void productSearch() {
		...
		Assert.assertNotSame(afterSearchingTheProductPagetitle, afterSelectingTheRandomProductPagetitle,
				"Either Random Product not selected or the Searched Product Not-Found.");
	 ...
	 */
	@Test(groups = { "regression" }, description = "Different Kinds of Payment Options can be availed.", priority = 6)
	public void paymentBasedOnThePaymentOption() {
		checkoutPage.continueToPayment();
		boolean paymentDone = checkoutPage.paymentForThePurchase();
		Assert.assertTrue(paymentDone, "Payment Button is disabled. So, payment can not be done.");
